...
const OurMission = () => {
  return (
    <div className="bg-gradient-to-r from-black via-purple-700 to-black text-white container my-10">
      <div>
      ...
      <div className="flex flex-col justify-center md:flex-row items-center gap-5 mt-8">
        ...
        <div className="w-full md:w-2/4 space-y-4">
          <h1 className="font-bold text-primary text-lg lg:text-3xl">
            Menciptakan mobil elegan dan berkelas untuk yang kelas atas
          </h1>
